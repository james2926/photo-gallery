...
export default function About() {
  return (
    <>
      <SubHeader />
      <section className="flex flex-row items-center justify-stretch bg-black text-white px-4 md:px-10 md:space-y-0 space-y-8">
        <div className="mx-auto flex flex-col md:flex-row items-center md:gap-12 gap-y-8">
          <div className="w- items-start justify-start">
            <h1 className="md:text-[260px] text-[80px] md:leading-[210px] leading-[76px] font-semibold tracking-[-0.04em]">
              BEYOND <br />
              THE —
              <br />
              FRAME.
      ...
      <section className="md:py-[150px] py-[120px] md:px-10 px-4">
        <div className="flex flex-col items-start justify-between md:gap-y-6 gap-y-10">
          <p className="text-2xl leading-[30px] font-semibold tracking-[-0.02em] text-gray-500">
            PHOTOGRAPHER BASED IN <br />
            OSAKA — TOKYO
          </p>
          <div className="md:flex md:flex-row flex-col items-center justify-between gap-x-12 w-full md:h-12 grid grid-cols-2 md:space-x-0 gap-y-12">
            <Image
      ...
      <section className="bg-black text-white pt-[120px] pb-[250px] md:px-10 px-4">
        <div className="mx-auto flex flex-col md:flex-row gap-12">
          <div className="md:w-1/3">
            <h2 className="text-[80px] leading-[76px] font-semibold tracking-[-0.03em]">
              AWARDS
            </h2>
            <h4 className="text-gray-500 text-2xl text-[42px] leading-[42px] font-semibold tracking-[-0.02em] mt-4">
              <span className="hidden md:inline">
          ...
          <div className="md:w-2/3">
            {awards.map((award, index) => (
              ...
              >
                <span className="text-2xl leading-[30px] text-gray-500 text-nowrap">
                  {award.name}
                </span>
                <span className="text-2xl leading-[30px] text-gray-500 text-nowrap">
                  {award.organization}
